package com.zuehlke.financemanager.security.service;
...
import com.zuehlke.financemanager.security.repository.RefreshTokenRepository;
...
public class RefreshTokenService {
    @Value("${finance_manager.app.jwtRefreshExpirationMs}")
